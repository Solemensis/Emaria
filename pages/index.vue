...
<template lang="">
	<div>
		<div v-once class="container">
			<div data-aos="zoom-out" data-aos-duration="1200" class="hero-section page-format">
				<img
				...
				<div class="hero-left">
					...
					<div class="buttons">
						<NuxtLink to="/shop"> <button class="shop-button">Go Shop</button></NuxtLink
						><a href="#dest"><button class="learn-button">Learn More ⬇</button></a>
					</div>
...
.learn-button:active {
	background-image: linear-gradient(to right, #ced6e7 0%, #c0cee2 51%, #cad9f6 100%);

	animation: button-pop 0.3s ease-out;
}

.shop-button:active {
	background-image: linear-gradient(to right, #ba21d8 0%, #832dcd 51%, #b41fd1 100%);
...
.arrow {
	filter: invert(17%) sepia(49%) saturate(7495%) hue-rotate(317deg) brightness(90%) contrast(95%);
	height: 11rem;
	position: absolute;
	left: -5%;
	top: 50%;
